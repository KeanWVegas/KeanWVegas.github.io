        ...
        <div class="navlogo">
            <nav class="nav">
                ...
                <div id="sidenav" class="sidenav">
                    ...
                    <a href="#" class="navbutton" id="signUpNav" onclick="OpenModal(); openNav();"> Sign Up</a>
                </div>
                ...
                <div class="navigationlarge">
                    <div class="box">
                        ...
                        <div class="drop"><a href="" class="navbutton" onclick="OpenModal()">Sign Up</a></div>
    ...
    <main>
        ...
        <div class="slider">
            <div class="slides fade">
                <div class="slidetext"> Mat Hoffman: Helped to build the sport's popularity for decades. He created some of the most entertaining and insane tricks of the time, and made way for the sport to evolve. </div>
                <img src="/images/mat.jpg" style="width:100%">
            </div>
            <div class="slides fade">
                <div class="slidetext"> Ryan Nyquist: Has been riding professionally since 1995 and first competed in the X Games in 1996.  In 2016 he made his way to Red Bull Joyride, placing top 10 at 9 out of the 18 riders. </div>
                <img src="/images/ryan.jpg" style="width:100%">
            </div>
            <div class="slides fade">
                <div class="slidetext"> Morgan Wade: One of the most prolific and entertaining riders. Wade competed in the 2006 and 2007 X-Games in the Freestyle and Big Air competitions. He won gold in the 2013 X Games Los Angeles for Big Air - BMX. </div>
                <img src="/images/morgan.png" style="width:100%">
            </div>
        ...
        <div class="modalBox" id="modalBox">
            <form id="myform" type="post" class="form">
                <fieldset>
                    ...
                    <p>Please sign up for our website and newsletter!</p>
                    <div>
